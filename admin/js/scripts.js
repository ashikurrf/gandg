$(document).ready(function (){
	...
	// var chart = new ApexCharts($("#lineChart2")[0], options);
	// chart.render();
	...
	// var chart = new ApexCharts($("#lineChart3")[0], options);
	// chart.render();
...
Apex.grid = {
  ...
  var optionDonut = {
	...
	labels: ['Phone', 'Laptop', 'Headphone', 'Smart Watch', 'Accessories'],
	legend: {
	  position: 'left',
	  offsetY: 80
	}
